export function load_textures(gl){
	return {
		bricks_texture: load_texture_from_file(gl, 'res/textures/bricks_texture.jpg'),
		bricks_normal: load_texture_from_file(gl, 'res/textures/bricks_normal.jpg'),
	};
}

function load_texture_from_file(gl, path_to_file){
