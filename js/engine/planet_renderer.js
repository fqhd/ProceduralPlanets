...
function load_planet_shape_params(gl, planet_params){
	const uniforms = ['ocean_size', 'ocean_depth', 'ocean_floor', 'mountain_height', 'mountain_frequency', 'mountain_scale', 'detail_frequency', 'detail_scale', 'ocean_floor_smoothing', 'land_edge_smoothing', 'mountain_mask'];
